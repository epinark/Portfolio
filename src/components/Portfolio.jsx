              ...
              <div className="project-card">
                <div className="project-card-inner">
                  ...
                  <span className="description">
                    ...
                    Dolor placeat vero at ratione dolore adipisci officia culpa
                    nesciunt similique maiores corrupti, reiciendis inventore
                    est deserunt mollitia harum cupiditate impedit facere?
                    <ul className="skills">
              ...
              <div className="project-card">
                <div className="project-card-inner">
                  ...
                  <span className="description">
                    ...
                    trivia questions from an API and allows users to test their
                    knowledge and see their scores.
                    <ul className="skills">
                      <li className="skill">React</li>
                      <li className="skill">Api</li>
                    </ul>
